...
export const COURSES: Courses[] = [
    ...
    },
    {
        ...
        img: "zumba.jpg",
        description: "Get ready to groove to the beat in our high-energy Zumba and Dance Fitness classes! These fun, dance-based workouts are designed to get your heart pumping, burn calories, and boost your mood all while having a blast. Whether you're a seasoned dancer or just love moving to music, our Zumba and Dance Fitness classes are perfect for all fitness levels. Led by energetic, certified instructors, these classes combine exciting rhythms, easy-to-follow steps, and the latest music hits, making every session feel like a party. It's not just a workout—it's a celebration of movement, rhythm, and fun!"
    },
    {
        name: "Group Cycling",
        days: "Monday,Friday",
